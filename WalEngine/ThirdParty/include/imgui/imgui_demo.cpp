...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            if (io.ConfigFlags & ImGuiConfigFlags_NoMouse) // Create a way to restore this flag otherwise we could be stuck completely!
            {
                ...
                if (ImGui::IsKeyPressed(ImGui::get_keyIndex(ImGuiKey_Space)))
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        {
            ImGui::TextWrapped("You can use ImGui::get_mouseDragDelta(0) to query for the dragged amount on any widget.");
            ...
            if (ImGui::IsItemActive())
            {
                ...
                // You can request a lower or higher threshold using the second parameter of IsMouseDragging() and get_mouseDragDelta()
                ImVec2 value_raw = ImGui::get_mouseDragDelta(0, 0.0f);
                ImVec2 value_with_lock_threshold = ImGui::get_mouseDragDelta(0);
        ...
        if (ImGui::TreeNode("Mouse cursors"))
        {
            ...
            ImGui::Text("Current mouse cursor = %d: %s", ImGui::get_mouseCursor(), mouse_cursors_names[ImGui::get_mouseCursor()]);
            ImGui::Text("Hover to see mouse cursors:");
            ImGui::SameLine(); ShowHelpMarker("Your application can render a different mouse cursor based on what ImGui::get_mouseCursor() returns. If software cursor rendering (io.MouseDrawCursor) is set ImGui will draw the right cursor for you, otherwise your backend needs to handle it.");
